  ...
  */}
        ...
        <div className="w-full max-w-md bg-white rounded-3xl border border-slate-200/80 p-8 text-center shadow-xl shadow-slate-100/50 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-slate-500 leading-relaxed max-w-xs mx-auto">
              We couldn' retrieve the information for this unit. Check your network or try again.
            </p>
          </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4 p-4 z-20 bg-white border-b border-slate-200/80 shadow-md">

        {/* Global Compact Context Header */}
        <div className="flex flex-row items-center justify-between gap-4 pt-1">
          <div className="space-y-1 ">
            <div className="flex items-center gap-3">
              <div className="md:w-12 md:h-12 rounded-xl bg-indigo-50 border border-indigo-100 flex items-center justify-center text-indigo-600">
                <House className="w-7 h-7" />
              </div>
              <h1 className="md:text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight">
                Unit {unit?.name || '—'}
              </h1>
