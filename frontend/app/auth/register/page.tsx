...
import { CircleAlert, Eye, EyeOff, User, Mail, Phone, MapPin, Lock, Upload, X, ArrowRight, CircleCheckBig } from "lucide-react";
                ...
                {success ? (
                    <div className="text-center">
                        <div className="inline-flex items-center justify-center mb-4">
                            <CircleCheckBig className="w-18 h-18 animate-bounce text-green-500" />
                        </div>
                        <h1 className="text-2xl font-bold text-gray-900 tracking-tight">Account created successfully</h1>
                        ...
                        <div className="mt-6">
                            <Link 
                                ...
                                className="inline-flex items-center gap-2 px-8 py-3.5 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-semibold text-sm rounded-xl shadow-lg shadow-blue-600/30 hover:shadow-xl hover:shadow-blue-600/40 hover:scale-[1.02] transition-all duration-300 group"
                            >
