...
import { 
  AlertCircle, RefreshCw, DollarSign, ChevronDown, ChevronUp, 
  FileText, RefreshCcw, PieChart, ArrowUpRight, ArrowDownRight,
  CalendarDays
} from 'lucide-react';
        ...
        <div className="px-5 pb-5">
          <div className="flex items-center justify-between gap-3 pt-4 border-t border-gray-100">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 text-gray-700 font-medium text-sm rounded-xl hover:bg-gray-50 hover:border-gray-300 transition-all disabled:opacity-50 shadow-sm"
            >
              <RefreshCcw className={`w-4 h-4 ${isSummaryFetching ? "animate-spin" : ""}`} />
              {isSummaryFetching ? 'Refreshing...' : 'Refresh'}
            </button>
          </div>
