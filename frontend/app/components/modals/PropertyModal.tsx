...
import { usePropertyTypes } from "@/app/hooks/queries/usePropertyQueries";
...
const PropertyModal = () => {
    ...
    const { data: propertyTypesData, isLoading: isPropertyTypesLoading } = usePropertyTypes();
    ...
    if (success) {
        return (
            <Modal 
                label={isEditing ? 'Property Updated Successfully!' : 'Property Created Successfully!'} 
                    ...
                    <div className="text-center p-6">
                        ...
                        <p className="text-gray-600">
                            {isEditing 
                                ...
                                : 'Your property has been created successfully. You can now add units.'
                            }
                        </p>
                    </div>
                }
            ...
            <form className="space-y-5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <select
                                ...
                                className={`w-full pl-9 pr-3 py-2.5 border ${errors.property_type ? 'border-red-300' : 'border-gray-300'} rounded-lg text-sm text-gray-900 bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition appearance-none cursor-pointer`}
                            >
                                <option value="" className="text-gray-400">
                                    Select type
                                </option>
                                {propertyTypesData?.map((type: any) => (
                        ...
                        {errors.property_type && (
                            <p className="mt-1.5 text-sm text-red-600">{errors.property_type[0]}</p>
                        )}
                    </div>
                    ...
                    <div>
                        ...
                        {errors.location && (
                            <p className="mt-1.5 text-sm text-red-600">{errors.location[0]}</p>
                        )}
                    </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 pt-4 border-t border-gray-200">
                    ...
                    <button 
                        ...
                        disabled={!name || !selectedPropertyType || !location || updatePropertyMutation.isPending || !hasChanges()}
                        className="flex items-center justify-center gap-2 px-8 py-2.5 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition disabled:opacity-60 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                    >
